    ...
    <section className="px-5 py-7 pb-10">
      <div className="max-w-7xl mx-auto bg-blue-600 rounded-3xl px-8 md:px-14 py-14 flex flex-col lg:flex-row items-center justify-between gap-10">
        ...
        <div className="text-white">
          ...
          <p className="mt-6 text-blue-100 max-w-xl md:text-xl">
        ...
        <button className="bg-white text-blue-600 font-semibold px-10 py-5 rounded-xl hover:scale-105 transition md:text-xl">
          Enroll Now
        </button>
      </div>
    </section>
